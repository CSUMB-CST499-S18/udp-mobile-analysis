...
ggplot(west, aes(percent)) + 
  ...
  scale_y_continuous(name="West Average UDP Jitter 3 (Milliseconds)", limits=c(0,15)) +
  ggtitle("West Phone UDP Jitter 3 (Round 12)")
...
ggplot(east, aes(percent)) + 
  ...
  scale_x_continuous(name="Percentage (%)", limits=c(0, 100)) +
  scale_y_continuous(name="East Average UDP Jitter 3 (Milliseconds)", limits=c(0,15)) +
  ggtitle("East Phone UDP Jitter 3 (Round 12)")
