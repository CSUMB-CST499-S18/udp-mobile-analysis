...
mydatafiltered$wUDP.Jitter4 <- gsub("^[a-z].*", "Inf", mydatafiltered$wUDP.Jitter4)
mydatafiltered$eUDP.Jitter4 <- gsub("^[a-z].*", "Inf", mydatafiltered$eUDP.Jitter4)
...
ggplot(west, aes(percent)) + 
  ...
  ggtitle("West Phone UDP Jitter 4 (Round 1)")
...
ggplot(east, aes(percent)) + 
  ...
  ggtitle("East Phone UDP Jitter 4 (Round 1)")
