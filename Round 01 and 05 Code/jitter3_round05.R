...
mydatafiltered$wUDP.Jitter3 <- gsub("NA", "Inf", mydatafiltered$wUDP.Jitter3)
mydatafiltered$eUDP.Jitter3 <- gsub("NA", "Inf", mydatafiltered$eUDP.Jitter3)
...
ggplot(west, aes(percent)) + 
  ...
  ggtitle("West Phone UDP Jitter 3 (Round 5)")
...
ggplot(east, aes(percent)) + 
  ...
  ggtitle("East Phone UDP Jitter 3 (Round 5)")
