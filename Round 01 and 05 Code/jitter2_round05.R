...
mydatafiltered$wUDP.Jitter2 <- gsub("NA", "Inf", mydatafiltered$wUDP.Jitter2)
mydatafiltered$eUDP.Jitter2 <- gsub("NA", "Inf", mydatafiltered$eUDP.Jitter2)
...
ggplot(west, aes(percent)) + 
  ...
  ggtitle("West Phone UDP Jitter 2 (Round 5)")
...
ggplot(east, aes(percent)) + 
  ...
  ggtitle("East Phone UDP Jitter 2 (Round 5)")
